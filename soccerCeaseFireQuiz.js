...
const QUIZ_NAME = "soccerCeaseFireQuiz";
...
const questions = [
    {
        question: "During which war did the Christmas Truce soccer game happen?",
        choices: [
            "WW1",
            "WW2",
            "Korean War",
    ...
    {
        question: "What year did the Christmas Truce happen?",
        choices: ["1945", "1939", "1914", "1920"],
        answer: 2
    },
    {
        question: "Where did soldiers meet during the Christmas Truce?",
        choices: ["In London", "An Airbase", "In a Stadium", "No Man's Land"],
        answer: 3
    }
];
